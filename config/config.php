...
# Ideally, this should match the domain name
	define('APP_EMAIL', 'hhuangweijia@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'weijiahuang@fas.harvard.edu');
	// sent to you when you have problem for the application 

# Default DB name for this app
	define('DB_NAME', "geohango_p2_geohangout_biz"); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'AFDAFAFSFAFDAFAW');
	define('TOKEN_SALT', 'AFADFADFADSFWAEAWFE');
